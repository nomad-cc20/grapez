...
print(_test_feedforward(tc, 8, 2, 6, 1, 200))
print(_test_feedforward(tc, 4, 2, 6, 1, 200))
print(_test_feedforward(tc, 8, 3, 6, 1, 200))
print(_test_feedforward(tc, 8, 2, 10, 1, 200))
print(_test_feedforward(tc, 8, 2, 6, 3, 200))
